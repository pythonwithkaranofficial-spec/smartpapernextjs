  ...
  "10": {
    ...
    hindi: {
      chapters: [
        ...
        "क्षितिज (काव्य खंड): राम-लक्ष्मण-परशुराम संवाद (तुलसीदास)",
        "क्षितिज (काव्य खंड): आत्मकथ्य (जयशंकर प्रसाद)",
        "क्षितिज (काव्य खंड): उत्साह और अट नहीं रही (सूर्यकांत त्रिपाठी 'निराला')",
        "क्षितिज (काव्य खंड): यह दंतुरित मुस्कान और फसल (नागार्जुन)",
        "क्षितिज (काव्य खंड): संगतकार (मंगलेश डबराल)",
        "क्षितिज (गद्य खंड): नेताजी का चश्मा (स्वयं प्रकाश)",
        "क्षितिज (गद्य खंड): बालगोबिन भगत (रामवृक्ष बेनीपुरी)",
        ...
        "कृतिका भाग-2: माता का आँचल (शिवपूजन सहाय)",
        "कृतिका भाग-2: साना-साना हाथ जोड़ि (मधु कांकरिया)",
        "कृतिका भाग-2: मैं क्यों लिखता हूँ? (अज्ञेय)",
        "व्यावहारिक व्याकरण: रचना के आधार पर वाक्य भेद (4 अंक)",
        "व्यावहारिक व्याकरण: वाच्य (4 अंक)",
        "व्यावहारिक व्याकरण: पद परिचय (4 अंक)",
        "व्यावहारिक व्याकरण: अलंकार - उपमा, रूपक, उत्प्रेक्षा, अतिशयोक्ति, मानवीकरण (4 अंक)",
        "रचनात्मक लेखन: अनुच्छेद लेखन (लगभग 120 शब्द, 6 अंक)",
        "रचनात्मक लेखन: पत्र लेखन - औपचारिक एवं अनौपचारिक (लगभग 100 शब्द, 5 अंक)",
        "रचनात्मक लेखन: स्ववृत्त लेखन अथवा ई-मेल लेखन (लगभग 80 शब्द, 5 अंक)",
        "रचनात्मक लेखन: विज्ञापन लेखन अथवा संदेश लेखन (लगभग 40 शब्द, 4 अंक)",
        "अपठित बोध: अपठित गद्यांश (लगभग 250 शब्द, 7 अंक)",
        "अपठित बोध: अपठित काव्यांश (लगभग 120 शब्द, 7 अंक)"
      ],
      notes: "सीबीएसई कक्षा 10 हिन्दी 'अ' (कोड सं. 002) नवीनतम पाठ्यक्रम। निर्धारित पुस्तकें: क्षितिज भाग-2 एवं कृतिका भाग-2 (एन.सी.ई.आर.टी.)। 80 अंक सैद्धांतिक बोर्ड परीक्षा एवं 20 अंक आंतरिक मूल्यांकन।"
    },
    sanskrit: {
      chapters: [
  ...
  "12": {
    physics: {
      chapters: [
        ...
        "Unit I - Electrostatics: Chapter-2 Electrostatic Potential and Capacitance",
        "Unit II - Current Electricity: Chapter-3 Current Electricity",
        "Unit III - Magnetic Effects of Current & Magnetism: Chapter-4 Moving Charges and Magnetism",
        "Unit III - Magnetic Effects of Current & Magnetism: Chapter-5 Magnetism and Matter",
        "Unit IV - Electromagnetic Induction & Alternating Currents: Chapter-6 Electromagnetic Induction",
        "Unit IV - Electromagnetic Induction & Alternating Currents: Chapter-7 Alternating Current",
        "Unit V - Electromagnetic Waves: Chapter-8 Electromagnetic Waves",
        "Unit VI - Optics: Chapter-9 Ray Optics and Optical Instruments",
        "Unit VI - Optics: Chapter-10 Wave Optics",
        "Unit VII - Dual Nature of Radiation & Matter: Chapter-11 Dual Nature of Radiation and Matter",
        "Unit VIII - Atoms & Nuclei: Chapter-12 Atoms",
    ...
    cs: {
      chapters: [
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-1 Python Revision Tour",
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-2 Functions",
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-3 Exception Handling",
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-4 File Handling (Text Files)",
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-5 File Handling (Binary Files - Pickle Module)",
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-6 File Handling (CSV Files)",
        "Unit 1 - Computational Thinking and Programming - 2: Chapter-7 Data Structure (Stack using List)",
        "Unit 2 - Computer Networks: Chapter-8 Evolution of Networking & Data Communication",
        "Unit 2 - Computer Networks: Chapter-9 Transmission Media, Network Devices & Topologies",
        "Unit 2 - Computer Networks: Chapter-10 Network Protocols & Web Services",
        "Unit 3 - Database Management: Chapter-11 Database Concepts & Relational Data Model",
        "Unit 3 - Database Management: Chapter-12 Structured Query Language (DDL & DML Commands)",
        "Unit 3 - Database Management: Chapter-13 SQL Functions, Grouping & Joins",
        "Unit 3 - Database Management: Chapter-14 Interface of Python with SQL Database"
      ],
      notes: "CBSE Class 12 Computer Science (Subject Code 083) 2025-26 Syllabus. Total Theory Marks: 70 (3 Hours), Practical: 30 Marks. Units: Unit 1 Computational Thinking & Programming - 2 (40M), Unit 2 Computer Networks (10M), Unit 3 Database Management (20M)."
    },
    ip: {
      chapters: [
    ...
    english: {
      chapters: [
        ...
        "Vistas: Memories of Childhood (The Cutting of My Long Hair & We Too are Human Beings)",
        "Creative Writing Skills: Notice Writing (up to 50 words)",
        "Creative Writing Skills: Formal / Informal Invitation & Reply (up to 50 words)",
        "Creative Writing Skills: Letters - Job Application with Bio-data / Resume",
        "Creative Writing Skills: Letters - Letter to the Editor (Public Interest Issues)",
        "Creative Writing Skills: Article Writing (120-150 words)",
        "Creative Writing Skills: Report Writing (120-150 words)",
        "Reading Skills: Unseen Passage (Factual, Descriptive or Literary - 12 Marks)",
        "Reading Skills: Unseen Case-Based Factual Passage (with Visual/Statistical Data - 10 Marks)"
      ],
      notes: "CBSE Class 12 English Core (Subject Code 301). Theory: 80 Marks (Section A Reading: 22M, Section B Creative Writing: 18M, Section C Literature: 40M), Internal Assessment: 20 Marks (ALS: 10M, Project: 10M). Prescribed Books: Flamingo (Prose & Poetry) & Vistas (Supplementary Reader)."
    },
    englishcore: {
      chapters: [
        "Flamingo (Prose): The Last Lesson",
    ...
    geography: {
      chapters: [
        "Fundamentals of Human Geography: Unit I - Chapter 1: Human Geography (Nature and Scope)",
        "Fundamentals of Human Geography: Unit II - Chapter 2: The World Population Distribution, Density and Growth",
        "Fundamentals of Human Geography: Unit II - Chapter 3: Human Development",
        "Fundamentals of Human Geography: Unit III - Chapter 4: Primary Activities",
        "Fundamentals of Human Geography: Unit III - Chapter 5: Secondary Activities",
        "Fundamentals of Human Geography: Unit III - Chapter 6: Tertiary and Quaternary Activities",
        "Fundamentals of Human Geography: Unit III - Chapter 7: Transport, Communication and Trade",
        "Fundamentals of Human Geography: Unit III - Chapter 8: International Trade",
        "Fundamentals of Human Geography: Map Work (World Political Map - 5 Marks)",
        "India - People and Economy: Unit I - Chapter 1: Population Distribution, Density, Growth and Composition",
        "India - People and Economy: Unit II - Chapter 2: Human Settlements",
        "India - People and Economy: Unit III - Chapter 3: Land Resources and Agriculture",
        "India - People and Economy: Unit III - Chapter 4: Water Resources",
        "India - People and Economy: Unit III - Chapter 5: Mineral and Energy Resources",
        "India - People and Economy: Unit III - Chapter 6: Planning and Sustainable Development in Indian Context",
        "India - People and Economy: Unit IV - Chapter 7: Transport and Communication",
        "India - People and Economy: Unit IV - Chapter 8: International Trade",
        "India - People and Economy: Unit V - Chapter 9: Geographical Perspective on Selected Issues and Problems",
        "India - People and Economy: Map Work (India Political Map - 5 Marks)",
        "Geography Practical Part II: Chapter 1: Data - Its Source and Compilation",
        "Geography Practical Part II: Chapter 2: Data Processing",
        "Geography Practical Part II: Chapter 3: Graphical Representation of Data",
        "Geography Practical Part II: Chapter 4: Spatial Information Technology"
      ],
      notes: "CBSE Class 12 Geography (Subject Code 029) 2025-26 Syllabus. Total Theory Marks: 70 (3 Hours), Practical: 30 Marks. Fundamentals of Human Geography (35 Marks: Unit I 3M, Unit II 8M, Unit III 19M, World Map 5M). India: People and Economy (35 Marks: Unit I 5M, Unit II 3M, Unit III 10M, Unit IV 7M, Unit V 5M, India Map 5M). Practical Part II (30 Marks: Data & Processing 18M, Spatial Tech 7M, Viva 5M)."
    },
    economics: {
      chapters: [
        "Part A - Macroeconomics: Unit 1 - National Income and Related Aggregates",
        "Part A - Macroeconomics: Unit 2 - Money and Banking",
        "Part A - Macroeconomics: Unit 3 - Determination of Income and Employment",
        "Part A - Macroeconomics: Unit 4 - Government Budget and the Economy",
        "Part A - Macroeconomics: Unit 5 - Balance of Payments and Foreign Exchange",
        "Part B - Indian Economic Development: Unit 6 - Development Experience (1947-90) & Economic Reforms since 1991",
        "Part B - Indian Economic Development: Unit 7 - Current Challenges: Human Capital Formation",
        "Part B - Indian Economic Development: Unit 7 - Current Challenges: Rural Development",
        "Part B - Indian Economic Development: Unit 7 - Current Challenges: Employment (Growth, Informalisation & Issues)",
        "Part B - Indian Economic Development: Unit 7 - Current Challenges: Sustainable Economic Development",
        "Part B - Indian Economic Development: Unit 8 - Development Experience of India (Comparison with Neighbours - Pakistan & China)"
      ],
      notes: "CBSE Class 12 Economics (Subject Code 030) 2025-26 Syllabus. Total Theory Marks: 80 (3 Hours), Project: 20 Marks. Part A: Introductory Macroeconomics (40 Marks: National Income 10M, Money & Banking 6M, Determination of Income & Employment 12M, Government Budget 6M, Balance of Payments 6M). Part B: Indian Economic Development (40 Marks: Development Experience & Reforms 12M, Current Challenges 20M, Comparison with Neighbours 8M)."
    },
    accounts: {
      chapters: [
