          ...
          <div className="space-y-6">
            ...
            <GlassCard className="p-6 sm:p-8 border-slate-200/90 dark:border-border/50 bg-card/90 dark:bg-card/40 space-y-4 shadow-xs">
              ...
              <div className="space-y-3 text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
                ...
                <ul className="list-disc pl-5 space-y-2 text-slate-700 dark:text-slate-200">
                  <li>Standard accounts and anonymous visitors are subject to a daily limit of <strong className="text-indigo-700 dark:text-indigo-300 font-bold">5 question papers per 24-hour window</strong>.</li>
            ...
            <GlassCard className="p-6 sm:p-8 border-slate-200/90 dark:border-border/50 bg-card/90 dark:bg-card/40 space-y-4 shadow-xs">
              ...
              <div className="space-y-3 text-sm text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
                ...
                <ul className="list-disc pl-5 space-y-2 text-slate-700 dark:text-slate-200">
                  <li>
                    <strong className="text-indigo-700 dark:text-indigo-300 font-bold">Your Generated Papers:</strong> Educators and institutions retain full rights to use, edit, print, distribute, and conduct tests using question papers generated through their session.
                  </li>
                  <li>
                    <strong className="text-indigo-700 dark:text-indigo-300 font-bold">Platform Ownership:</strong> Smart Paper AI retains all intellectual property rights over the software source code, branding, custom UI components, algorithms, and prompt templates.
                  </li>
                </ul>
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-6 sm:p-8 border-indigo-200/90 dark:border-indigo-500/30 bg-gradient-to-r from-indigo-500/5 via-purple-500/5 to-pink-500/5 dark:from-indigo-500/5 dark:via-purple-500/5 dark:to-pink-500/5 space-y-4 shadow-xs">
              ...
              <div className="p-4 rounded-xl bg-card dark:bg-background/80 border border-slate-200 dark:border-border/50 inline-block font-mono text-xs text-slate-900 dark:text-foreground shadow-2xs font-semibold">
                Support Email: <a href="mailto:tpaofficial1999@gmail.com" className="text-indigo-600 dark:text-indigo-400 hover:underline font-bold">tpaofficial1999@gmail.com</a> (Karan Sir)
              </div>
            </GlassCard>
