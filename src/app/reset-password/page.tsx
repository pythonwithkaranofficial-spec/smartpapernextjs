...
import { Sparkles, Lock, Eye, EyeOff, Loader2, CheckCircle2, ArrowRight } from "lucide-react";
      ...
      <main className="flex-grow pt-28 pb-20 flex items-center justify-center px-4">
        <Suspense fallback={
          <GlassCard className="max-w-md w-full p-8 text-center space-y-4">
            ...
            <p className="text-xs text-muted-foreground">Loading password reset page...</p>
          </GlassCard>
        }>
          <ResetPasswordForm />
        </Suspense>
